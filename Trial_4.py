...
st.set_page_config(page_title="Airbnb Cleaning Schedule", layout="wide")
st.title("Airbnb Cleaning Schedule")
st.write("This app will help you create a cleaning schedule for your Airbnb property using on a .ics file.")
